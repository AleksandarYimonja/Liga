...
namespace Liga
{
    public partial class Klub : Form
    {
        ...
        private void Load_Data()
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM Klub", veza);
        ...
        private void Klub_Load(object sender, EventArgs e)
        {
            Load_Data();
            Txt_Load();
        }
        ...
        {
            StringBuilder naredba = new StringBuilder("INSERT INTO klub (naziv) VALUES('");
        ...
        {
            StringBuilder naredba = new StringBuilder("UPDATE klub SET ");
        ...
        {
            string naredba = "DELETE FROM klub WHERE id = " + txtID.Text;
